...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        LoginActivity.LoginAsyncTask loginAsyncTasks = new LoginActivity.LoginAsyncTask();
    ...
    public void onRegisterClick(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://atmosroad.leopold-jacquet.com/register"));
